...
header_data = []
header_data << header
header_data << [version, data_offset, load_address, init_address, play_address, songs, start_song, speed]
header_data.flatten!
header_data << author
header_data << title
header_data << released

# Convert header_data to binary
header_data = header_data.pack("a4 S S S S S S S a32 a32 a32")
