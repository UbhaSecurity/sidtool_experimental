...
module SidtoolExperimental
  ...
  def self.display_file_info(emulator, options)
    if emulator.sid_file_info
      puts "SID File Information:"
      puts "Title: #{emulator.sid_file_info[:title]}"
      puts "Author: #{emulator.sid_file_info[:author]}"
      puts "Released: #{emulator.sid_file_info[:released]}"
      puts "Load Address: #{emulator.sid_file_info[:load_address]}"
      puts "Init Address: #{emulator.sid_file_info[:init_address]}"
      puts "Play Address: #{emulator.sid_file_info[:play_address]}"
      puts "Songs: #{emulator.sid_file_info[:songs]}"
      puts "Speed: #{emulator.sid_file_info[:speed]}"
    else
